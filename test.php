...
<section class="content">
 ...
 <div class="form-group">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">{{$language['wf_permissions']}}</h3>
                    <p class="help-block">{{$language['wf_permsn_info']}}</p>
                </div>
                        ...
                        <div class="chart tab-pane" id="view-tab">
                            <div class="row form_row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <p class="help-block">Select departments from this list for set the permission.</p>  
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row form_row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <p class="help-block">Select users from this list for set the permission.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row form_row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9"> 
                                        <input type="checkbox" id="view_authentication"  name="view_authentication" data-original-title="" title="" value="view">  Enable view permission
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="chart tab-pane" id="delete-tab">
                            ...
                            <div class="row form_row">
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-9"> 
                                        <input type="checkbox" id="delete_authentication"  name="delete_authentication" data-original-title="" title="" value="delete">  Enable delete permission
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="chart tab-pane" id="edit-tab">
                            ...
                            <div class="row form_row">
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-9"> 
                                        <input type="checkbox" id="edit_authentication"  name="edit_authentication" data-original-title="" title="" value="edit">  Enable edit permission
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="chart tab-pane  active" id="add-tab">
                            ...
                            <div class="row form_row">
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-9"> 
                                        <input type="checkbox" id="add_authentication"  name="add_authentication" data-original-title="" title="" value="add">  Enable add permission
                                    </div>
                                </div>
                            </div>
                        </div>
